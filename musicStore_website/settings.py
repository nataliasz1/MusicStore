"""
Django settings for musicStore_website project.
...
PROJECT_DIR = os.path.join(BASE_DIR, "musicStore_website")
...
SECRET_KEY = 'django-insecure-b8vr__11ax)vn_%4h3!#!s^bf+u^tsh6kimpg0v7ab%6v^*nag'
...
ROOT_URLCONF = 'musicStore_website.urls'
