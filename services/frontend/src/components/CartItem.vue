<template>
  <div class="orderItemContainer">
    <b-card
      ...
      <b-row no-gutters>
        <b-col md="1">
          <b-card-img v-if="product.images.length > 0" :src="product.images[0].img_url" class="cart-item-image"/>
          <b-card-img v-if="product.images.length === 0" src="../assets/guitar.png" class="cart-item-image"/>
        </b-col>
        <b-col md="11">
