...
class ApiCatalogitem(models.Model):
...
class ApiOpinion(models.Model):
    opinion_id = models.BigAutoField(primary_key=True)
    text = models.CharField(max_length=500)
    stars = models.CharField(max_length=1)
    product = models.ForeignKey(ApiCatalogitem, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'api_opinion'
