...
class Order(models.Model):
    ...
    #catalog_item = models.PositiveIntegerField(null=False)
    STATUS_CHOICES = (
    ("0", "created"),
    ("1", "completed"),
    ("2", "pending payment"),
...
class OrderItem(models.Model):
    ...
    def __str__(self):
        return 'PK:%d, catalog_item_id: %d, quantity: %d, price: %.2f' % (self.order_item_id, self.catalog_item_id, self.quantity, self.price)
